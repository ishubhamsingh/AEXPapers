...
public class Constants {
    public static final String BASE_URL= "http://stats.aospextended.com/";
    public static final String TAG= "AEXPapersStats";
    ...
    public static final String KEY_VERSION = "5.0";
